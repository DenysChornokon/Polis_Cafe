...
function Menu() {
    ...
    return (
        <section className="menu" id="menu">
            ...
            <h2 className="menuSection" onClick={() => setShowSalads(!showSalads)}>Салати</h2>
            {showSalads && (
            ...
            <h2 className="menuSection" onClick={() => setShowOsnovni_stravy(!showOsnovni_stravy)}>Основні страви</h2>
            {showOsnovni_stravy && (
                <div className="menuSectionContainer zacusky">
            ...
            <h2 className="menuSection" onClick={() => setShowSupy(!showSupy)}>Супи</h2>
            {showSupy && (
                <div className="menuSectionContainer zacusky">
            ...
            <h2 className="menuSection" onClick={() => setShowDomashnia_kukhnia(!showDomashnia_kukhnia)}>Домашня кухня</h2>
            ...
            <h2 className="menuSection" onClick={() => setShowGarniry(!showGarniry)}>Гарніри</h2>
            {showGarniry && (
                <div className="menuSectionContainer zacusky">
            ...
            <h2 className="menuSection" onClick={() => setShowPizza_and_burgers(!showPizza_and_burgers)}>Піца & Бургери</h2>
            ...
            <h2 className="menuSection" onClick={() => setShowStravy_na_kompaniyu(!showStravy_na_kompaniyu)}>Страви на компанію</h2>
